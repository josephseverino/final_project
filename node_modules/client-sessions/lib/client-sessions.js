...
console.log('maxage', opts.cookie.maxAge);
    this.expires = new Date(new Date().getTime() + opts.cookie.maxAge);
  } else {
console.log('no maxage');
...
console.log('new expires', this.expires);
    }
  },
  ...
  box: function() {
console.log('box', this.opts, this._content, this.duration, this.createdAt);
...
console.log('updatecookie', this.opts.cookie.expires);

      try {
        this.cookies.set(this.opts.cookieName, this.box(), this.opts.cookie);
      } catch (x) {
console.error('catch(x)', x);
